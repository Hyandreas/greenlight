...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('baselineBuddy.checkFile', () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('baselineBuddy.checkWorkspace', () => {
      diagnosticProvider.checkWorkspace();
    })
  );

  context.subscriptions.push(
    vscode.commands.registerCommand('baselineBuddy.clearDiagnostics', () => {
